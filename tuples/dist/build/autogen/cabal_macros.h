...
/* package tuples-0.1.0.0 */
#define VERSION_tuples "0.1.0.0"
#define MIN_VERSION_tuples(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tuples-0.1.0.0"

#define CURRENT_PACKAGE_KEY "tuples-0.1.0.0"
